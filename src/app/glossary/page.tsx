...
const TERMS = [
  ...
  },
  {
    id: "wind",
    title: "風度儀表板是什麼？",
    body: "風力度分數看「指數相對 MA5／月／季線的結構清楚程度」，不用乖離率大小當主力道，也不是多空分數。右上角標籤是站上／跌破結構。分級：強風＝多頭或空頭排列完整；陣風＝站上或跌破月／季線但尚未排齊；亂流＝均線方向打架且波動偏高；無風＝均線糾結、波動低。櫃買亂流／無風門檻略高。金流 active 在每日 18:00 灰度切換前，維持上個交易日收盤結果，開頁即可讀到正確快取。",
  },
  {
    id: "cache",
    title: "為什麼第一次很慢、之後較快？",
    body: "伺服器永遠先讀 active（上個交易日定稿）；平日 18:00 前重建只寫 staging，18:00／18:30／19:00 才灰度切 active。冷啟動若無 active 會用 last-close 保底或背景重建。瀏覽器另做 stale-while-revalidate：先進本機快取再背景同步。",
  },
  {
    id: "fear",
    title: "波動情緒指標怎麼算？",
